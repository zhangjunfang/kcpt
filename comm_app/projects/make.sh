...
auto_make()
{
	MAKEFILES="rediscache datapool netfile nodeserver pccv4 pushsrv wasv4"
	...
	MAKEFILES="$MAKEFILES dispatcher_808 roadinfo was_bd was_hb photo_3g proxy pcc_special pcc_guizhou"
	MAKEFILES="$MAKEFILES simply_forward pcc_wuhan pcc_shenzhen forward_jt808 jt808v2_cli jt809v2_cli"
	for i in $MAKEFILES
	do 
		cd "$orig_dir/$i"
		make 
